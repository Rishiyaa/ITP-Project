...
export default class CreateDelivery extends Component {
    ...
    render() {
        return (<div  >
           ...
           <div class = "col-6" >
           <br/>
           <img src="https://riser.ca/wp-content/uploads/2019/09/Banner-05.gif" width="60%" height="40%" />
           </div> <div class = "col-6" >
           <div div class = "myformstyle" >
           <div className = "card-body" >
           <div className = "col-md-8 mt-4 mx-auto" > </div> 
           <h3 className = "text-center" > 
           <font face = "Comic sans MS" size = "6" > New Delivery Vehicle Details</font>
           </h3 > <br></br>
