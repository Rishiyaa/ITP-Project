...
const Home = () => {
  ...
  const aa = () => {
    history.push("/Invetory/");
  };

  const bb = () => {
    history.push("/Invetory-report/");
  };
          ...
          <div className="col-12">
            ...
            >
              <div className="container">
                <h1 className="display-4" style={{color: "#07a3f7", fontFamily: "consolas", fontWeight:"bold",display: 'flex',  justifyContent:'center', alignItems:'center'}}> Inventory</h1>
              </div>
            </div>
          </div>
        </div>
