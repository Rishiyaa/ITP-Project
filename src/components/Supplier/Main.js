          ...
          <div className="col-12">
            ...
            >
              <div className="container">
                <h1 className="display-4" style={{color: "#F7AB07", fontFamily: "consolas", fontWeight:"bold",display: 'flex',  justifyContent:'center', alignItems:'center'}}>Supplier</h1>
              </div>
            </div>
          </div>
        </div>
