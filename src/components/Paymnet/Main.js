...
const Home = () => {
  ...
  const aa = () => {
    history.push("/Paymnet/");
  };

  const bb = () => {
    history.push("/Paymnet-report/");
  };
          ...
          <div className="col-12">
            ...
            >
              <div className="container">
                <h1 className="display-4" style={{color: "#F7AB07", fontFamily: "consolas", fontWeight:"bold",display: 'flex',  justifyContent:'center', alignItems:'center'}}>Payment</h1>
              </div>
            </div>
          </div>
        </div>
